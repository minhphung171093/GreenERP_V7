...
//			var imageData = '<div id="imageDataContainer" class="clearfix"><div id="imageData"><div id="imageDetails"><span id="caption"></span><span id="numberDisplay"></span></div><div id="bottomNav">';
		...
		*/
		...
		$.fn.lightbox.defaults = {
		    triggerEvent: "click",
			allSet: false,
			fileLoadingImage: '/green_erp_multi_image/static/lib/lightbox/images/loading.gif',
			fileBottomNavCloseImage: '/green_erp_multi_image/static/lib/lightbox/images/closelabel.gif',
			overlayOpacity: 0.6,
			borderSize: 10,
