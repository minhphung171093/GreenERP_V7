openerp.green_erp_multi_image = function(openerp) {
            ...
            if (this.id) {
                ...
                _.each(images_list, function (index) {
                    if (index['name'] == clicked ) {
                        ...
                        name_desc = 'Title:-' + title + '<br/><br/>Description:-' +description
                    }
                });
        ...
        if (images_list) {
            _.each(images_list, function (index) {
                if (index) {
                    var title = index['name_1'] ? index['name_1'] : ''
                    var description = index['description'] ? index['description'] : ''
                    url_list.push({"url" :index['name'], "title": '<p>Title:-' + title + '<br/><br/>Description:-' +description+'</p>'})
                }
            });
        }
        else {
