openerp.unleashed.module('green_erp_booking_chart').ready(function(instance, booking, _, Backbone, base) {
    ...
    instance.web.client_actions.add('booking.debug.generator', 'instance.green_erp_booking_chart.DataGenerator');
    instance.green_erp_booking_chart.DataGenerator = instance.web.Widget.extend({
        events: {
            'click .generate': 'run'
        },
