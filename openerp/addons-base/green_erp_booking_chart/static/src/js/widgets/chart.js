openerp.unleashed.module('green_erp_booking_chart').ready(function(instance, booking, _, Backbone, base){
    ...
    instance.green_erp_booking_chart.FieldChartSelector = FieldChartSelector;
    instance.web.form.widgets.add('booking_chart_selector', 'instance.green_erp_booking_chart.FieldChartSelector');
});