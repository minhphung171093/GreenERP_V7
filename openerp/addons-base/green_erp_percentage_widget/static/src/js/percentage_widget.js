...
##############################################################################
*/
openerp.green_erp_percentage_widget = function(instance) {
    var _t = instance.web._t,
        _lt = instance.web._lt;
    var QWeb = instance.web.qweb;

    // form view
    instance.web.form.widgets.add('percentage', 'instance.green_erp_percentage_widget.PercentageWidget');
    instance.green_erp_percentage_widget.PercentageWidget = instance.web.form.FieldFloat.extend({
