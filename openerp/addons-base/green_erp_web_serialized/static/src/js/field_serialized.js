openerp.unleashed.module('green_erp_web_serialized').ready(function(instance){
    ...
    instance.green_erp_web_serialized.FieldSerialized = FieldSerialized;
    instance.web.form.widgets.add('serialized', 'openerp.green_erp_web_serialized.FieldSerialized');
});
