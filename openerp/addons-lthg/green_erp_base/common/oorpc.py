...
class OpenObjectRPC:
    ...
    def create(self, model, field_values, context={}):
        """
        ...
        """
        return self._sock.execute(self._dbname, self._uid, self._password, model, 'create', field_values,context)
    ...
    def search(self, model, criteria, context={}):
        ...
        """
        return self._sock.execute(self._dbname, self._uid, self._password, model, 'search', criteria, context)
    ...
    def write(self, model, ids, field_values, context={}):
        ...
        Example: TODO
        """
        return self._sock.execute(self._dbname, self._uid, self._password, model, 'write', ids, field_values,context)
    ...
    def delete(self, model, ids, context={}):
        ...
        """
        return self._sock.execute(self._dbname, self._uid, self._password, model, 'unlink', ids, context)
