openerp.green_erp_widget_radio = function (instance)
{
    instance.web.form.widgets.add('radio', 'instance.green_erp_widget_radio.FieldRadio');
    instance.green_erp_widget_radio.FieldRadio = instance.web.form.AbstractField.extend(instance.web.form.ReinitializeFieldMixin, {
        template: 'FieldRadio',
        events: {
