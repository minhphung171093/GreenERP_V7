(function(openerp){
     ...
     * 
     * @module      green_erp_web_unleashed
    ...
    _.extend(Marionette.Module.prototype, {
         ...
         * @param {Object} base       the green_erp_web_unleashed module, useful to inherit from useful basic object
         *                            (ie. BaseCollection, ...)
         */
        ready: function(callback){
            this.addInitializer(function(options){
                ...
                callback.apply(this, [
                    ...
                    LatestUnderscore,
                    LatestBackbone,
                    this.app.module('green_erp_web_unleashed')
                ]);
            });
        },
    ...
    // null until green_erp_web_unleashed module is initialized...
    var sync = null;
    ...
    Unleashed.addInitializer(function(options){
        ...
        this.module = function(name, callback){
            var call = function(){
                ...
                if(callback){
                    callback.apply(this, [this, LatestUnderscore, LatestBackbone, this.app.module('green_erp_web_unleashed')]);
                }
            };
         ...
         * Note: this method is available only when the "green_erp_web_unleashed" model is initialized
         * 
    ...
    Unleashed.module('green_erp_web_unleashed').ready(function(instance, base, _, Backbone){
