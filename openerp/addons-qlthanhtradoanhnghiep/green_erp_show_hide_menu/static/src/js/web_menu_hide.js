openerp.green_erp_show_hide_menu = function (instance) {
        ...
        bind_events: function () {
            ...
            self.$el.on('click', '#web_menu_hideshow', function () {
                ...
                if (!visible) {
                    ...
                    root.find('.web_hide_show').css('background-image', 'url("/green_erp_show_hide_menu/static/src/img/terp-gtk-go-back-ltr.png")');
                    ...
                    root.find('.web_hide_show').css('background-image', 'url("/green_erp_show_hide_menu/static/src/img/terp-gtk-go-back-rtl.png")');
                }
