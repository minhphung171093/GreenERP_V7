openerp.unleashed.module('green_erp_booking_chart').ready(function(instance, booking, _, Backbone, base){
    ...
    var FieldSupportedModelsSelector = instance.web.form.FieldReference.extend({
        ...
        init:function(field_manager, node){ 
            ...
            this.field_chart_selector = _(field_manager.fields).find(function(field){
                return field instanceof instance.green_erp_booking_chart.FieldChartSelector;
            });
    ...
    instance.green_erp_booking_chart.FieldSupportedModelsSelector = FieldSupportedModelsSelector;
    instance.web.form.widgets.add('booking_supported_models_selector', 'instance.green_erp_booking_chart.FieldSupportedModelsSelector');
});
