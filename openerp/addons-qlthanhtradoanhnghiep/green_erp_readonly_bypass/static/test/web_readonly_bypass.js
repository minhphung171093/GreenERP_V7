openerp.testing.section( 'green_erp_readonly_bypass', {},
function(test){
        test('ignore_readonly', function(instance){
            openerp.green_erp_readonly_bypass(instance);
            var data = {};
            var mode_create = true;
            var options = {};
            var context = {};
            instance.green_erp_readonly_bypass.ignore_readonly(data, options,
                mode_create, context);
            deepEqual(data,
                {},
        ...
        test('retrieve_readonly_by_pass_fields', function(instance){
            ...
            var options = {'readonly_fields': {'field_1': 'va1-1',
                                               ...
                                               'field_3': 'val-3'}};
            deepEqual(
                instance.green_erp_readonly_bypass.retrieve_readonly_by_pass_fields(
                    options, context),
