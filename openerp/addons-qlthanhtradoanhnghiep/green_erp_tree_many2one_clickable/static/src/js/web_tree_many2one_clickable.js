...
openerp.green_erp_tree_many2one_clickable = function(openerp)
{
    openerp.web.list.columns.add(
            'field.many2one_clickable',
            'instance.green_erp_tree_many2one_clickable.Many2OneClickable');
    openerp.green_erp_tree_many2one_clickable.Many2OneClickable = openerp.web.list.Column.extend({
