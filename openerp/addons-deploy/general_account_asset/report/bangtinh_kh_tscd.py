...
class Parser(report_sxw.rml_parse):
    ...
    def get_line(self, master_id):
        sql = '''
            ...
            where depreciation_date between '%s' and '%s' and asset_id = %s
    ...
    def get_total(self):
        ...
        total.append(({
                      'nguyen_gia': sum_purchase_value,
                      'haomonluyke_dk': sum_depreciated_value,
                      'gt_conlai_dk': sum_gt_conlai,
                      'so_thang_kh': sum_method_number,
                      'khau_hao': sum_amount,
                      'nguyen_gia_cl': sum_purchase_value,
                      'haomonluyke_ck': sum_haomonluyke_ck,
                      'gt_conlai_ck': sum_gt_conlai_ck,
                      }))
#         for i in total:
#             print i['nguyen_gia']
        return total
