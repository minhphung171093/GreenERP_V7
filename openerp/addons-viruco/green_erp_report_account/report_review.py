...
class account_ledger_report_review_line(osv.osv):
    ...
    _columns = {
        'ledger_review_id': fields.many2one('account.ledger.report.review', 'Ledger', readonly=True,ondelete='cascade'),
...
class so_quy_review_line(osv.osv):
    ...
    _columns = {
        'so_quy_review_id': fields.many2one('so.quy.review', 'so quy', readonly=True,ondelete='cascade'),
        'ngay_ghso': fields.char('Ngày, tháng ghi sổ', size=1024),
