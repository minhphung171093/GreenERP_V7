...

{
    ...
    'depends': ['green_erp_viruco_menu','web','base','purchase','sale','sale_stock','product','properties','report_aeroo','report_aeroo_ooo','stock','account','green_erp_readonly_bypass','web_m2x_options','green_erp_tree_many2one_clickable'],
    'data': [
