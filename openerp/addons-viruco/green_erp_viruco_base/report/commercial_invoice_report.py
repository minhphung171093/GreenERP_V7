        ...
        for line in o.draft_bl_line:
            if line.option and line.option == 'product':
                ...
                for seal in line.description_line:
                    ...
                    self.amount += total
                    product +=seal.hopdong_line_id and seal.hopdong_line_id.product_id and seal.hopdong_line_id.product_id.eng_name + ' '+ seal.hopdong_line_id.product_id.default_code + '\n' or '',
                    res.append({ 'product': product,
