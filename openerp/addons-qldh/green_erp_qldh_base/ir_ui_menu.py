...
#             #Thanh: Update Menu Sequence
#             sequence = 10
#             for menu_name in ['Customers', 'Suppliers', 'Bank and Cash',
#                               'Sale and Purchase Receipt', 'HRM Accounting',
#                               'Stock Account', 'MRP Accounting', 'Assets',
#                               'Journal Entries', 'Charts', 'Periodic Processing', 'Reporting'
#                               'Configuration']:
#                 
#                 cr.execute("update ir_ui_menu set sequence=%s where parent_id=%s and name=%s", (sequence, root, menu_name))
#                 sequence += 10
ir_ui_menu()
