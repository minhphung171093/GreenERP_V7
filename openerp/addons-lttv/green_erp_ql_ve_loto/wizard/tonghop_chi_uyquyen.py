...
class tonghop_chi_uyquyen(osv.osv_memory):
    _name = "tonghop.chi.uyquyen"
    ...
    def print_report(self, cr, uid, ids, context=None):
        ...
        datas['model'] = 'tonghop.chi.uyquyen'
        datas['form'] = self.read(cr, uid, ids)[0]
        datas['form'].update({'active_id':context.get('active_ids',False)})
        return {'type': 'ir.actions.report.xml', 'report_name': 'tonghop_chi_uyquyen_report', 'datas': datas}
