...
class chitiet_vetuchon_trungthuong(osv.osv_memory):
    _name = "chitiet.vetuchon.trungthuong"
    
    def default_get(self, cr, uid, fields, context=None):
        res = super(chitiet_vetuchon_trungthuong, self).default_get(cr, uid, fields, context=context)
    ...
    def print_report(self, cr, uid, ids, context=None):
        ...
        datas['model'] = 'chitiet.vetuchon.trungthuong'
        datas['form'] = self.read(cr, uid, ids)[0]
        datas['form'].update({'active_id':context.get('active_ids',False)})
        return {'type': 'ir.actions.report.xml', 'report_name': 'chitiet_vetuchon_trungthuong_report', 'datas': datas}
        
chitiet_vetuchon_trungthuong()
