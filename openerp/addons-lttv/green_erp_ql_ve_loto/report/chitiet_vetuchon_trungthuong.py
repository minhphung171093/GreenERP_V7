        ...
        if self.data_dict.get(dlcha.id, False):
            if self.data_dict[dlcha.id].get(menhgia.id, False):
                ...
                return {
                    'line': lines,
                    'tong': {
                        'tong_sl_2_d': format(chitiets['tong']['tong_sl_2_d'], ',').split('.')[0].replace(',','.'),
                        'tong_tien_2_d': format(chitiets['tong']['tong_tien_2_d'], ',').split('.')[0].replace(',','.'),
                        'tong_sl_2_c': format(chitiets['tong']['tong_sl_2_c'], ',').split('.')[0].replace(',','.'),
                        'tong_tien_2_c': format(chitiets['tong']['tong_tien_2_c'], ',').split('.')[0].replace(',','.'),
                        'tong_sl_2_dc': format(chitiets['tong']['tong_sl_2_dc'], ',').split('.')[0].replace(',','.'),
                        'tong_tien_2_dc': format(chitiets['tong']['tong_tien_2_dc'], ',').split('.')[0].replace(',','.'),
                        'tong_sl_2_18': format(chitiets['tong']['tong_sl_2_18'], ',').split('.')[0].replace(',','.'),
                        'tong_tien_2_18': format(chitiets['tong']['tong_tien_2_18'], ',').split('.')[0].replace(',','.'),
                        'tong_sl_2': format(chitiets['tong']['tong_sl_2'], ',').split('.')[0].replace(',','.'),
                        'tong_tien_2': format(chitiets['tong']['tong_tien_2'], ',').split('.')[0].replace(',','.'),
                        'tong_sl_3_d': format(chitiets['tong']['tong_sl_3_d'], ',').split('.')[0].replace(',','.'),
                        'tong_tien_3_d': format(chitiets['tong']['tong_tien_3_d'], ',').split('.')[0].replace(',','.'),
                        'tong_sl_3_c': format(chitiets['tong']['tong_sl_3_c'], ',').split('.')[0].replace(',','.'),
                        'tong_tien_3_c': format(chitiets['tong']['tong_tien_3_c'], ',').split('.')[0].replace(',','.'),
                        'tong_sl_3_dc': format(chitiets['tong']['tong_sl_3_dc'], ',').split('.')[0].replace(',','.'),
                        'tong_tien_3_dc': format(chitiets['tong']['tong_tien_3_dc'], ',').split('.')[0].replace(',','.'),
                        'tong_sl_3_7': format(chitiets['tong']['tong_sl_3_7'], ',').split('.')[0].replace(',','.'),
                        'tong_tien_3_7': format(chitiets['tong']['tong_tien_3_7'], ',').split('.')[0].replace(',','.'),
                        'tong_sl_3_17': format(chitiets['tong']['tong_sl_3_17'], ',').split('.')[0].replace(',','.'),
                        'tong_tien_3_17': format(chitiets['tong']['tong_tien_3_17'], ',').split('.')[0].replace(',','.'),
                        'tong_sl_3': format(chitiets['tong']['tong_sl_3'], ',').split('.')[0].replace(',','.'),
                        'tong_tien_3': format(chitiets['tong']['tong_tien_3'], ',').split('.')[0].replace(',','.'),
                        'tong_sl_4_16': format(chitiets['tong']['tong_sl_4_16'], ',').split('.')[0].replace(',','.'),
                        'tong_tien_4_16': format(chitiets['tong']['tong_tien_4_16'], ',').split('.')[0].replace(',','.'),
                        'tong_sl_4': format(chitiets['tong']['tong_sl_4'], ',').split('.')[0].replace(',','.'),
                        'tong_tien_4': format(chitiets['tong']['tong_tien_4'], ',').split('.')[0].replace(',','.'),
                        'tong_slan_trung': format(chitiets['tong']['tong_slan_trung'], ',').split('.')[0].replace(',','.'),
                        'tong_sluong_trung': format(chitiets['tong']['tong_sluong_trung'], ',').split('.')[0].replace(',','.'),
                        'tong_thanhtien': format(chitiets['tong']['tong_thanhtien'], ',').split('.')[0].replace(',','.'),
                    },
                }
        return {
            'line': [],
