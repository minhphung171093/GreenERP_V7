...
openerp.green_erp_web_google_map = function(instance) {
    ...
    function ensure_jquery_ui_map_loaded() {
        ...
        $.getScript('/green_erp_web_google_map/static/lib/js/jquery.ui.map.js',
                    function() {
    ...
    instance.green_erp_web_google_map.form = {};
     ...
     */
    instance.green_erp_web_google_map.form.FieldGoogleMap = instance.web.form.AbstractField.extend(instance.web.form.ReinitializeFieldMixin, {
        template: 'GoogleMap',
     ...
     */
    instance.green_erp_web_google_map.form.FieldO2MGoogleMap = instance.web.form.AbstractField.extend(instance.web.form.ReinitializeFieldMixin, {
    ...
    instance.web.form.widgets = instance.web.form.widgets.extend({
        'm2m_gmap': 'openerp.green_erp_web_google_map.form.FieldO2MGoogleMap',
        'o2m_gmap': 'openerp.green_erp_web_google_map.form.FieldO2MGoogleMap',
        'gmap': 'openerp.green_erp_web_google_map.form.FieldGoogleMap',
    });
