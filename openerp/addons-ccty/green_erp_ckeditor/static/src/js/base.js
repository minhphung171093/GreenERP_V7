...
*/
CKEDITOR_BASEPATH = '/green_erp_ckeditor/static/lib/js/ckeditor/';
...
openerp.green_erp_ckeditor = function (oe) {
    ...
    oe.web.form.widgets.add('ckeditor', 'openerp.green_erp_ckeditor.FieldTextCKEditor');

    oe.green_erp_ckeditor.FieldTextCKEditor = oe.web.form.AbstractField.extend(oe.web.form.ReinitializeFieldMixin, {
