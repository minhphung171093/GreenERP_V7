...
class co_cau(osv.osv):
    ...
    _columns = {
        ...
        'loai_hinh_so_huu_id':fields.many2one('loai.hinh.so.huu','Loại hình sở hữu'),
        ...
        'xu_ly_moi_truong_ids': fields.many2many('xu.ly.moi.truong','cocau_chan_nuoi_xu_ly_ref','chan_nuoi_id','xu_ly_id','Xử lý môi trường'),
